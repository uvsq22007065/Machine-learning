...
class GaitPhaseEstimator:
    def __init__(self):
        ...
        self.model_path = os.path.join(package_path, "log", "learning_models", f"{self.patient}_modelLSTM.keras")
    ...
    def estimate_phase(self):
        if self.modelLoaded and self.angleUpdated and self.forceUpdated:
            ...
            current_input = np.array(current_input).reshape(1, 1, 4)
